...
with open("victorize.pickle", "rb") as fp:
    data = pickle.load(fp)
...
eng_vectorizer.set_weigths(data["engvec_weights"])
fra_vectorizer = TextVectorization.from_config(data["fravec_config"])
fra_vectorizer.set_weigths(data["fravec_weights"])
...
def make_dataset(pairs, batch_size=64):
    ...
    # Convert them into, and then create tensors
